...
C {vsource.sym} -180 30 0 0 {name=Vcm value=\{vcm\} savecurrent=false}
C {gnd.sym} -230 80 0 0 {name=l1 lab=GND}
C {isource.sym} -60 -460 0 0 {name=I0 value=\{ib\}}
...
C {vsource.sym} -160 -460 0 0 {name=V4 value=\{vdd\}\} savecurrent=false}
...
.option warn=1
"}
C {code_shown.sym} 780 -320 0 0 {name=CONTROL only_toplevel=false value=
"
.control
	* run ac simulation 
	ac dec 20 1k 100e6
