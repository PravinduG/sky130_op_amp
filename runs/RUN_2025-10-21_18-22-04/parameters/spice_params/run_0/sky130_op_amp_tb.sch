...
C {lab_pin.sym} 60 -430 0 0 {name=p16 sig_type=std_logic lab=Ven}
...
"}
C {vsource.sym} -310 -460 0 0 {name=Ven value=\{Ven\} savecurrent=false}
C {gnd.sym} -310 -380 0 0 {name=Ven1 lab=GND
value=\{Ven\}}
C {lab_pin.sym} -310 -520 1 0 {name=Ven2 sig_type=std_logic lab=Ven
value=\{Ven\}}
