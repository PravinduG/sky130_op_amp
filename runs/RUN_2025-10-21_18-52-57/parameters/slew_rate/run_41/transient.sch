...
C {devices/vsource.sym} 140 130 0 0 {name=V2 value=1.9 savecurrent=false}
C {devices/vcvs.sym} 690 310 0 1 {name=Evdrv1 value=1}
C {devices/vsource.sym} 300 130 0 0 {name=V3 value="DC 0 PWL(0 0 100n 0 100.1n 1.9)" savecurrent=false}
